    ...
    <div class="main_container">
        <div class="sidebar">
            <div class="sidebar_menu">
                <i class="fa-solid fa-house-chimney"></i><a href="dashboard.php?file=home.php&title=home">Home</a>
            </div>

            <div class="sidebar_menu">
                <i class="fa-solid fa-user"></i><a href="dashboard.php?file=profile.php&title=profile">Profile</a>
            </div>

            <div class="sidebar_menu">
                <i class="fa-solid fa-users"></i><a href="dashboard.php?file=users.php&title=users">Users</a>
            </div>
            <div class="sidebar_menu">
                <div class="menu_item">
                ...
                <div class="dropdown">
                    <div class="dropdown_menu">
                        <i class="fa-solid fa-angle-right"></i><a href="dashboard.php?file=add_post.php&title=post">Add
                            New Post</a>
                    </div>
                    <div class="dropdown_menu">
            ...
            <div class="sidebar_menu">
                ...
                <div class="dropdown">
                    <div class="dropdown_menu">
                        <i class="fa-solid fa-angle-right"></i><a
                            href="dashboard.php?file=add_product.php&title=products">Add New Product</a>
                    </div>
                    <div class="dropdown_menu">
                        <i class="fa-solid fa-angle-right"></i><a
                            href="dashboard.php?file=view_products.php&title=products">View Products</a>
                    </div>
